...
public interface IAIService : IAsyncDisposable
{
    ...
    Task<string> ChatAsync(
        IReadOnlyList<Circle.AI.Inference.ChatMessage> messages,
        Circle.AI.Inference.GenerationOptions? options = null,
    ...
    /// <see cref="Circle.AI.Tools.IToolBridge"/>. Returns a failure result
    /// when no bridge is wired up.
    /// </summary>
    Task<Circle.AI.Tools.ToolResult> InvokeToolAsync(
        Circle.AI.Tools.ToolInvocation invocation,
        CancellationToken ct = default);
