...
namespace Circle.AI.Languages.Language.Afrikaans;

/// <summary>
/// Afrikaans language pack for Circle AI.
/// Provides idiomatic expressions, cultural context, and prompt tuning
/// to make the AI reason naturally in Afrikaans (Afrikaans).
/// </summary>
public sealed class AfrikaansLanguagePack : ILanguagePack
{
    public static readonly AfrikaansLanguagePack Instance = new();
