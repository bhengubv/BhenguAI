...
// API in Bhengu.AI.Inference (QwenTextGenerator). This shim exists so older
// callers in Bhengu.AI.Embeddings can keep handing around SafeModelHandle
...
public static class PlatformInterop
{
    ...
    //    Bhengu.AI.Inference.LlamaCppInterop, kept here only because Core
