...
// Circle.AI.Core (e.g. PlatformInterop.LoadModel). With the llama.cpp
// pivot the on-device inference path lives in Circle.AI.Inference, which
...
// delegated via a managed callback so Circle.AI.Core doesn't need a P/Invoke
