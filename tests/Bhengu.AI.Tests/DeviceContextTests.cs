...
public sealed class MauiDeviceContextTests
{
    ...
    public void ImplementsIDeviceContext()
    {
        IDeviceContext ctx = new Bhengu.AI.Maui.MauiDeviceContext("tgn.butler");
        Assert.NotNull(ctx);
    }
    ...
    {
        var ctx = new Bhengu.AI.Maui.MauiDeviceContext("tgn.butler");
    ...
    {
        var ctx = new Bhengu.AI.Maui.MauiDeviceContext();
        Assert.Null(ctx.ActiveAppId);
    }
